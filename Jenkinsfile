pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Owusurk/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('owusurk-225')   // <---- Change this to match your kubernetes cluster credentials
    }
